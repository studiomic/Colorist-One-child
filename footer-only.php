<?php
/**
 * The template for displaying the footer NO!<footer-widgets>
 *
...
?>
	...
	<footer class="pageBottom" itemscope itemtype="https://schema.org/WPFooter">
		<div>
			<p>SINCE 1999</p>
			<p id="BackRoot"><a href="#top"><svg class="BackRoot" version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 992 771" preserveAspectRatio="xMidYMid meet">
